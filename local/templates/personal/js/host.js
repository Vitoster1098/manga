! function(e) {
    ...
    t.guid = function(e) {
        ...
        if (0 < e.length)
            for (var t = 0; t < e.length; t++)
                if (-1 !== e[t].name.toLowerCase().indexOf("flash")) {
    ...
    t.Config = function(e) {
        if (void 0 === e && (e = {}), !c) {
            ...
            (c = r.merge(d, e)).positions = {}, e.positions && r.forEachProp(e.positions, function(e, t) {
                c.positions[e] = s.PosConfig(r.merge(t, {
                    id: e
                }))
            }), c.auto && i.boot()
        }
    ...
    var n = o(1),
        ...
        i = function() {
            ...
            return e.prototype.setPositionReady = function(e) {
                ...
                return {
                    busy: this.busyStatuses[e] || null,
                    iframe: this.iframes[e] || null,
    ...
    var n = o(29),
        ...
        s = function() {
            ...
            return e.prototype.register = function(e, t, o) {
                ...
                var t = n.indexOf(this.iframes, e); - 1 !== t && (this.iframes.splice(t, 1), this.guids.splice(t, 1), this.callbacks.splice(t, 1))
    ...
    t.PosConfig = function(e, t, o) {
        var a;
        "object" == typeof e ? (a = e).dest = a.dest || t : a = {
            id: e
        };
        var u, d = "100%" === a.w ? a.w : parseInt(a.w, 10) || 0,
            c = "100%" === a.h ? a.h : parseInt(a.h, 10) || 0;
        if ((!d || !c) && a.size) {
            ...
            function e(t, o, s, l) {
                if (void 0 !== t)
                    if (a.isConfigReady()) {
                        ...
                        var p, h, g, v, m, y;
                        if ((p = "object" == typeof t ? t : {
                            id: t
                        }).html = o || p.html, p.meta = s || p.meta, p.conf = l || p.conf, p.id ? this.id = p.id : p.conf && p.conf.id ? this.id = p.conf.id : this.id = r.guid(u.POS_ID_AUTO_PREFIX), p.html ? this.html = p.html : p.src ? this.html = (h = p.src, v = (g = a.Config()) ? g.version : "undefined", m = d.isEnabled ? "1" : "0", y = r.getFlashVersion().toString(), ["<scr", 'ipt type="text/javascript" src="', h.replace(/\${sf_ver}/g, v).replace(/\${ck_on}/g, m).replace(/\${flash_ver}/g, y), '"></scr', "ipt>"].join("")) : this.html = "", this.src = "", this.meta = p.meta instanceof i.PosMeta ? p.meta : f.fromInlineCode(p.meta), p.conf) p.conf.id = this.id, this.conf = c.PosConfig(p.conf);
                        else {
                            var w = a.findPosConfig(this.id);
                            this.conf = w || c.PosConfig({
                                id: this.id
                            })
                        }
                    } else n.logError("Publisher Config not initialized - abort");
                else n.logError("posIDorObj is required")
            }
    ...
    function C(e) {
        ...
        if (s && (a = s.dest instanceof Element || Boolean(s.dest.nodeName) ? s.dest : document.getElementById(s.dest)), a) {
            ...
            var I = c.setStyle(C, l.toCssString(g.initialWrapStyle(b)), !1, {
                    nonce: b.nonce
                }),
                R = {
                    id: t,
            ...
            var A = [I, c.setStyle(N, l.toCssString(g.initialIframeStyle(b, k)), !1, {
                    nonce: b.nonce
                })],
                T = function(e) {
                    var t = h.Config();
    ...
    t.createIframe = _, t.render = function(e) {
        if (h.isConfigReady()) {
            var t = s.isArray(e) ? e : [e],
                o = a.map(t, function(e) {
    ...
    var n = o(29),
        ...
        s = function() {
            ...
            return e.prototype.register = function(e) {
                ...
                var t = n.indexOf(this.iframes, e); - 1 !== t && this.iframes.splice(t, 1)
            }, e.prototype.report = function() {
                if (0 !== this.iframes.length)
                    for (var e = document.hasFocus(), t = 0, o = this.iframes; t < o.length; t++) {
                        var n = o[t];
                        i.postMessages.send(n, {
                            type: "focus-updated",
                            hasFocus: e
                        })
                    }
    ...
    function i(e, t) {
        var o = n.getRect(e),
            ...
            i = o.bottom - o.top,
            s = Math.max(o.left, 0),
            a = Math.min(o.right, t.w),
            u = Math.max(o.top, 0),
            d = Math.min(o.bottom, t.h),
            c = Math.max(a - s, 0),
            f = Math.max(d - u, 0);
        return {
            t: Math.round(o.top),
    ...
    var n = o(29),
        ...
        a = function() {
            function e() {
                ...
                r.addEventListener(window, "scroll", t, {
                    passive: !0
                }), r.addEventListener(window, "resize", t, {
                    passive: !0
                })
            }
            return e.prototype.register = function(e) {
    ...
    var n = o(28),
        ...
        i = o(63),
        s = o(30),
        a = "yaSafeFrameAsyncCallbacks",
        u = window;
    u.$sf = u.$sf || {}, u.$sf.info = {
        errs: []
    }, u.$sf.host = r.merge(u.$sf.host || {}, i.host), u.$sf.host.conf && (s.parseInlineConfig(u.$sf.host.conf), delete u.$sf.host.conf);
    var d = function(e) {
        return setTimeout(e, 0)
    };
    u[a] && n.forEach(u[a], d), u[a] = {
        push: d
    }
}, function(e, t, o) {
    "use strict";
    ...
    var n = o(4),
        r = o(19).getNativeMethod(Array, "isArray");
    ...
    t.messageDispatcher = function(e, t, o) {
        if ("error" === o.type)
            for (var c = 0, f = o.messages; c < f.length; c++) {
                var l = f[c];
        ...
        if ("expand-request" === o.type) {
            ...
            d.status.setPositionExpanding(e), s.expand(t, h, o.dim), d.status.setPositionExpanded(e), u.postMessages.send(t, {
                type: "expanded"
            }), r.notifyPosMsg(e, "expand", o.dim)
        }
        if ("collapse-request" === o.type) {
            ...
            d.status.setPositionCollapsing(e), s.collapse(t, h), d.status.setPositionCollapsed(e), u.postMessages.send(t, {
                type: "collapsed"
            }), r.notifyPosMsg(e, "collapse")
        }
